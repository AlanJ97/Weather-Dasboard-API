...
DEFAULT_PROJECT_NAME="${PROJECT_NAME:-dashboard-weather-app}"  # e.g., weather-dashboard
DEFAULT_ORGANIZATION="${ORGANIZATION:-PersonalProject}"  # e.g., your-company
DEFAULT_COST_CENTER="${COST_CENTER:-Engineering}"  # e.g., Engineering
DEFAULT_TEAM_NAME="${TEAM_NAME:-DevOps-Team}"  # e.g., DevOps-Team
