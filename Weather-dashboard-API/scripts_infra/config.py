...
DEFAULT_CONFIG = {
    ...
    'project_name': 'dashboard-weather-app',  # e.g., 'weather-dashboard'
    'organization': 'PersonalProject',  # e.g., 'your-company'
    'cost_center': 'Engineering',  # e.g., 'Engineering'
    'team_name': 'DevOps-Team'  # e.g., 'DevOps-Team'
}
